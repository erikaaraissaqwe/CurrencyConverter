...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CurrencyConverterLiveData.conversionLiveData.observe(this) { conversionResult ->
            with(amb) {
                conversionResult.rates.values.first().rateForAmount.also { rateForAmount ->
                    resultTiet.setText(rateForAmount)
                }
            }
        }
